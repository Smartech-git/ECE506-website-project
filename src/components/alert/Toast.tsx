    ...
    <AnimatePresence>
      {toast.state === "success" && toast.open && (
        <motion.div
          ...
          className="fixed top-8 z-[99999]  mx-auto left-0 right-0 flex min-h-[66px] w-[90%] items-start justify-center gap-x-3 overflow-hidden rounded-[4px] bg-white px-4 py-3 shadow-main-lg sm:w-[370px]"
        >
